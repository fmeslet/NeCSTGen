...
#X = data.iloc[index][columns].values #[0:300000]
...
encoder.save(f"{MODELS_DIR}encoder_vae_{FULL_NAME}_{PROTO}_FINAL_2.h5")
decoder.save(f"{MODELS_DIR}decoder_vae_{FULL_NAME}_{PROTO}_FINAL_2.h5")
